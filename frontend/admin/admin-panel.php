                ...
                <div class="list-unstyled topbar-right">
                    <ul class="topbar-link">
                        ...
                        if(isset($_SESSION['loggedIn'])){
                            echo '<li><a href="../profile/profile-detail.php" title="">'.$_SESSION['email'].'</a></li>';
                            echo '<li><a href="../logout/logout.php" title="">Logout</a></li>';
                        }else {
                            echo '<li><a href="../login/login-page.php" title=""> Login </a></li>';
                        }
                        ?>
                    </ul>
    ...
    <nav class="navbar navbar-hover navbar-expand-lg navbar-soft">
        <div class="container">
            ...
            <figure class="mb-0 mx-auto">
                <a href="../dist/homepage-v1.php">
                     <img src="../dist/images/placeholder/logo.jpg" alt="" class="img-fluid logo">
                </a>
            </figure>
        ...
        <tbody>
            ...
            <?php
                function fetchNewsData() {
                    // cURL setup
                    $url = 'http://localhost/news/backend/api/v1/fetch_news.php';
                    $ch = curl_init($url);
                ...
                if ($newsData) {
                    foreach ($newsData as $row) {
                        ...
                        //update button
                        echo '<form action="update_news.php" method="POST" style="display:inline;">';
                        ...
                        echo '<input type="hidden" name="topic" value="' . htmlspecialchars($row['topic']) . '">';
                    ...
                    echo '<tr><td colspan="6" class="text-center">No news found.</td></tr>';
                }
            ?>
